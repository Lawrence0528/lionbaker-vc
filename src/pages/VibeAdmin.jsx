            ...
            {project.htmlCode && (
                <div className="space-y-2">
                    ...
                    <button
                        ...
                        className="w-full py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 border border-slate-200 rounded-lg text-center text-sm transition flex items-center justify-center gap-2"
                    >
                        {copyLinkMsg ? (
                    ...
                    {project.type === 'form' && (
                        <button
                            onClick={() => navigate(`/form-responses/${project.id}`)}
