...
export const PREMIUM_COLORS = [
    ...
    { name: '莫蘭迪粉', hex: '#c9a9a6', value: '莫蘭迪粉：低飽和度粉藕色，溫柔優雅，符合美睫美業的高雅氣質' },
...
export const DESIGN_STYLES = [
    ...
    { name: '美業高雅', value: '莫蘭迪粉或極簡香檳金，大圓角與柔和陰影，適合美睫沙龍與材料行的高級質感' },
];
...
export const INDUSTRY_TEMPLATES = {
    ...
    /** 美睫店＋材料行 - 莫蘭迪粉／極簡香檳金風格，專業美業版 */
    eyelashBeauty: {
        label: '美睫店 / 材料行 主理人',
        award: '專業美睫導師 / 材料批發顧問',
        services: '美睫技術教學、沙龍材料供應、創業導師課程',
        photoUrl: '',
        selfIntro: '我是美睫與材料行業的創業夥伴。不只提供頂級睫毛材料，更協助每位美睫師建立專業形象與經營心法。從技術精進到沙龍利潤精算，用 AI 工具與系統化教學，讓妳在美業路上少走彎路。',
        tips: [
            { title: '✨ 今天適合接哪款？', content: '輸入眼型與穿搭風格，AI 推薦 3 款最適合妳的睫毛款式，讓客人秒懂如何選擇。' },
            { title: '📣 社群吸睛文案產生器', content: '輸入作品風格與優惠活動，一鍵生成 IG/Threads 短文案，省下每天發文時間。' },
            { title: '🐎 2026 馬年美睫運勢', content: '測算今年幸運色、幸運眼型，例如：今年適合亮面纖維能擋小人，病毒式傳播增加曝光。' },
        ],
    },
};
...
export const INTERACTIVE_TEMPLATES = {
    ...
    eyelash_recommend: {
        label: '👁️ 美睫 - 今天適合接哪款？',
        requirements: '功能：根據客人眼型（圓眼、長眼）、當天穿搭風格（歐美、日系、名媛），AI 給出 3 個建議款式圖與說明。\n拓客機制：結果頁顯示「預約試接優惠」，點擊引導至 LINE 預約。',
    },
    /** 【專業美睫類】B 端學員 */
    eyelash_glue_timer: {
        label: '⏱️ 美睫 - 黑膠固化計數器',
        requirements: '功能：輸入現場濕度與溫度，AI 換算某款黑膠的乾透速度（例如：建議等待 1.5 秒再放手），對新手美睫師超級實用。\n拓客機制：算出建議後，引導「想掌握更多材料特性？加老師領取材料對照表」。',
    },
    /** 【專業美睫類】B 端店東 */
    salon_profit_calc: {
        label: '💰 美睫 - 沙龍利潤精算師',
        requirements: '功能：輸入材料成本、房租、抽成比例，AI 幫妳算出這副睫毛實際上賺多少錢，引導發現「用妳的材料更省錢」。\n拓客機制：精算完成後，按鈕引導至材料行官網或 LINE 詢價。',
    },
    /** 【美感心靈類】C 端 */
    charm_quiz: {
        label: '💫 美睫 - 電眼魅力指數測驗',
        requirements: '功能：上傳一張眼神照片，AI 幽默評分（例如：桃花指數 88%），附一句「如果接了 XX 款睫毛，桃花會破表喔！」。\n拓客機制：測完顯示推薦款式與「預約試接」按鈕，導流至 LINE。',
    },
    /** 【美感心靈類】B 端 */
    entrepreneur_quiz: {
        label: '👩‍💼 美睫 - 妳是哪一類創業女強人？',
        requirements: '功能：針對美睫師的的性格測驗（類 DISC）。測完告訴她「妳適合單打獨鬥」或「適合開連鎖店」。\n拓客機制：結果頁引導至導師課程或材料行合作方案，加 LINE 解鎖完整解析。',
    },
    /** 【美感心靈類】通用 */
    year_fortune: {
        label: '🐴 美睫 - 2026 馬年美睫運勢',
        requirements: '功能：測算今年幸運色、幸運眼型（例如：今年適合亮面纖維，能擋小人）。呼應生肖運勢的趣味互動。\n拓客機制：結果附「幸運款式預約優惠」，導流至 LINE。',
    },
    /** 【美力科技類】B 端 */
    social_copywriter: {
        label: '✍️ 美睫 - 社群吸睛文案產生器',
        requirements: '功能：輸入「作品風格（如：仙子毛）」和「優惠活動」，一鍵生成適合 IG/Threads 的短文案，幫美睫師省下發文時間。\n拓客機制：生成後顯示「想解鎖更多文案範本？加老師領取文案包」。',
    },
    eyelash_photo_prompt: {
        label: '📸 美睫 - 攝影指令碼 (Prompt)',
        requirements: '功能：提供幾組 Midjourney 或攝影參數，教美睫師如何拍出高級作品照。\n拓客機制：下載或複製指令碼前，引導加 LINE 領取進階版 Prompt 包。',
    },
    /** 【遊戲互動類】C 端 */
    eyelash_durability_game: {
        label: '🎮 美睫 - 睫毛持久度挑戰賽',
        requirements: '功能：像「請假理由產生器」一樣好玩。隨機生成「弄亂睫毛的 100 個理由」（如「睡覺跟枕頭打架」），測完送一張回補優惠券。\n拓客機制：優惠券需加 LINE 領取，導流至預約或材料購買。',
    },
    /** 【遊戲互動類】B 端 */
    reflex_challenge: {
        label: '⚡ 美睫 - 快手接睫反應大考驗',
        requirements: '功能：螢幕隨機出現歪掉的睫毛，學員要快速點擊糾正。計分制，類似反應大考驗。\n拓客機制：分數高的可兌換材料行購物金，引導加 LINE 領獎。',
    },
};
